...
const StatsInfoCard = ({ icon, lebel, value, color }) => {
  return (
    <>
      <div
        className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/100 border border-gray-200/50 z-10"
      >
        <div
        ...
        <div>
          <h6 className="text-xs text-gray-500 mb-1">{lebel}</h6>
